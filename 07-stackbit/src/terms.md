...
- **Country** refers to: STATE, United States

- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to COMPANY.
...
- **Website** refers to COMPANY, accessible from [https://www.example.com/](https://www.example.com/)
